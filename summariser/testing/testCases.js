const arsTechnica = {
    ...
    "content": 
        [
            ...
            [ 
                [ "h1", [ "Biden considers digital dollar—here’s how it could differ from regular money" ] ] 
            ], 
            [ 
                [ "h2", [ "Digital currency may have advantages but could also be tool for surveillance." ] ],
                [ "img", [ "https://cdn.arstechnica.net/wp-content/uploads/2021/05/getty-internet-dollar-signs-800x533.jpg", "Illustration of fiber Internet lines with dollar signs." ] ], 
                [ "p", [ "\"My Administration places the highest urgency on research and development efforts into the potential design and deployment options of a United States CBDC [Central Bank Digital Currency],\" the executive order said. \"These efforts should include assessments of possible benefits and risks for consumers, investors, and businesses; financial stability and systemic risk; payment systems; national security; the ability to exercise human rights; financial inclusion and equity; and the actions required to launch a United States CBDC if doing so is deemed to be in the national interest.\"", "Biden's order said a US-issued digital currency could be used to \"support efficient and low-cost transactions, particularly for cross‑border funds transfers and payments, and to foster greater access to the financial system, with fewer of the risks posed by private sector-administered digital assets\" such as bitcoin and other cryptocurrencies. But there are \"potential risks and downsides to consider,\" and Biden ordered federal agencies to prepare a report within six months analyzing the implications. Over 100 countries are already \"exploring or piloting\" CBDCs, the White House said.", "Biden also ordered government agencies to develop policies for managing cryptocurrencies that already exist. \"The rise in digital assets creates an opportunity to reinforce American leadership in the global financial system and at the technological frontier, but also has substantial implications for consumer protection, financial stability, national security, and climate risk,\" the White House said. Biden's order \"encourages regulators to ensure sufficient oversight and safeguard against any systemic financial risks posed by digital assets.\"", "Biden's order noted that \"negative climate impacts and environmental pollution... may result from some cryptocurrency mining.\" There would be no need for mining with a digital currency issued by a central bank.", "Bitcoin's price was up 8 percent today and other cryptocurrencies rose as Biden's order \"appeared to take a supportive stance toward the industry,\" CNBC wrote. Bitcoin's price has been highly volatile, as it \"began the pandemic at $7,300, peaked at around $68,000 before falling back down to about $39,000,\" a Biden administration official noted in a call with reporters yesterday." ] ] 
            ], 
            [ 
                [ "h2", [ "What is a Central Bank Digital Currency?" ] ], 
                [ "p", [ "The Federal Reserve explains that a Central Bank Digital Currency \"is generally defined as a digital liability of a central bank that is widely available to the general public.\" That's in contrast to the two current types of central bank money in the US: \"physical currency issued by the Federal Reserve and digital balances held by commercial banks at the Federal Reserve,\" a Federal Reserve FAQ said.", "\"While Americans have long held money predominantly in digital form—for example in bank accounts, payment apps or through online transactions—a CBDC would differ from existing digital money available to the general public because a CBDC would be a liability of the Federal Reserve, not of a commercial bank,\" the Federal Reserve says. Because it would be a liability of the Federal Reserve, \"a CBDC would be the safest digital asset available to the general public, with no associated credit or liquidity risk.\"", "A US-issued digital currency would in some ways be similar to stablecoins that are pegged to the value of the dollar. A major difference is that CBDCs would be issued by the Federal Reserve itself.", "The Federal Reserve says it hasn't decided whether to pursue a digital currency but notes that a CBDC \"could provide households and businesses a convenient, electronic form of central bank money, with the safety and liquidity that would entail; give entrepreneurs a platform on which to create new financial products and services; support faster and cheaper payments (including cross-border payments); and expand consumer access to the financial system.\"", "\"The Federal Reserve does not intend to proceed with issuance of a CBDC without clear support from the executive branch and from Congress, ideally in the form of a specific authorizing law,\" the Federal Reserve also says.", "A US CBDC wouldn't replace cash or paper currency. \"The Federal Reserve is committed to ensuring the continued safety and availability of cash and is considering a CBDC as a means to expand safe payment options, not to reduce or replace them,\" the Federal Reserve said.", "Senior Biden administration officials told reporters that \"the implications of potentially issuing a digital dollar are profound.\" But those officials added that they intend to \"maintain the centrality of the dollar in global financial markets and in the global economy.\" " ] ] 
            ], 
            [ 
                [ "h2", [ "Digital currency can be tool for surveillance" ] ], 
                [ "p", [ "Digital currency issued by a central bank can be used as a tool for government surveillance of citizens and control over their financial transactions. This has been a concern with China's digital currency, which is in early stages of rollout. As Akram Keram, an expert on China at the National Endowment for Democracy, wrote last year, \"With digital yuan, the CCP [Chinese Communist Party] will have direct control over and access to the financial lives of individuals, without the need to strong-arm intermediary financial entities. In a digital-yuan-consumed society, the government easily could suspend the digital wallets of dissidents and human rights activists, for example.\"", "The Federal Reserve said that any US-issued digital currency \"would need to strike an appropriate balance between safeguarding the privacy rights of consumers and affording the transparency necessary to deter criminal activity.\" That could be accomplished with an intermediated model in which \"the private sector would offer accounts or digital wallets to facilitate the management of CBDC holdings and payments,\" thus \"facilitat[ing] the use of the private sector's existing privacy and identity-management frameworks,\" the Federal Reserve said." ] ] 
            ], 
            [ 
                [ "h2", [ "Biden seeks analysis" ] ], 
                [ "p", [ "The report ordered by Biden is to be produced by the secretary of the treasury, in consultation with the secretary of state, attorney general, secretary of commerce, the secretary of homeland security, director of the Office of Management and Budget, and director of national intelligence.", "The report is supposed to analyze the potential implications of a digital currency on economic growth, stability, and \"financial inclusion\"; the relationship between a US-issued digital currency and digital assets administrated by the private sector; \"the future of sovereign and privately produced money globally and implications for our financial system and democracy\"; \"the extent to which foreign CBDCs could displace existing currencies and alter the payment system in ways that could undermine United States financial centrality\"; potential implications for national security, financial crime, and human rights; and the effects that foreign CBDCs may have on US interests generally.", "The executive order encourages the Federal Reserve to \"assess the optimal form of a United States CBDC\" and develop a strategic plan \"that evaluates the necessary steps and requirements for the potential implementation and launch of a United States CBDC.\" Biden also wants the Federal Reserve to evaluate how a CBDC \"could enhance or impede the ability of monetary policy to function effectively as a critical macroeconomic stabilization tool.\" Biden further asked federal agencies for an assessment of whether Congress would need to make legislative changes before the US can issue a digital currency." ] ] 
            ] 
    ]
};
        ...
        [
            [
                ...
                [
                    "img",
                    [
                        "https://images.anandtech.com/doci/17306/Apple-M1-Ultra-hero-220308_678x452.jpg",
                        ""
                    ]
                ],
                [
                    ...
                    [
                        ...
                        "Aimed squarely at desktops – specifically, Apple’s new Mac Studio – the M1 Ultra finds Apple once again upping the ante in terms of SoC performance for both CPU and GPU workloads",
                        "And in the process, Apple has thrown the industry a fresh curveball by not just combining two M1 Max dies into a single chip package, but by making the two dies present themselves as a single, monolithic GPU, marking yet another first for the chipmaking industry",
                        "Back when Apple announced the M1 Pro and the ridiculously powerful M1 Max last fall, we figured Apple was done with M1 chips",
                        "As for the company’s final and ultimate M1 chip design, the M1 Ultra, Apple has bonded two M1 Max dies together on to a single chip, with all of the performance benefits doubling their hardware would entail",
                        "And while double die strategy benefits sprawling multi threaded CPU and GPU workloads far more than it does more single threaded tasks – an area where Apple is already starting to fall behind – in the process they re breaking new ground on the GPU front",
            ...
            [
                ...
                [
                    "p",
                    [
                        "At the heart of the new M1 Ultra is something a bit older: the M1 Max",
                        "Specifically, Apple is using two M1 Max dies here, and then bonding them together to form a massive amalgamation of 114B transistors",
                        "M1 Ultra isn’t introducing anything new in teams of end user features in that respect, and instead the chip is all about scaling up Apple’s M1 architecture one step further by placing a second silicon die on a single chip",
                        "Starting with speeds and feeds, by placing two M1 Max dies on a single package, Apple has doubled the amount of hardware at their disposal in virtually every fashion",
                        "This means twice as many CPU cores, twice as many GPU cores, twice as many neural engine cores, twice as many LPDDR5 memory channels, and twice as much I/O for peripherals",
                        "Given that M1 Ultra is aimed solely at desktops (unlike M1 Max) the efficiency cores don’t have quite as big of a role to play here since Apple doesn’t need to conserve energy down to the last joule",
                        "The desktop focused nature of the chip means that, if they desire, Apple can push clockspeeds a bit higher than they did on the M1 Max, but they would need to leave their energy efficiency sweet spot to do it",
                        "In practice, I will be surprised if the M1 Ultra CPU cores are clocked much higher than on the M1 Max",
                        "Meanwhile, doubling the number of M1 Max dies on the chip means that Apple is able to double the number of memory channels on the chip, and thus their overall memory bandwidth",
                        "Whereas M1 Max had 16 LPDDR5 6400 channels for a total of 408GB/second of memory bandwidth, M1 Ultra doubles that to 32 LPDDR5 channels and 800GB/second of memory bandwidth",
                        "And as with the M1 Max, this is accomplished by soldering the LPDDR5 chips directly to the chip package, for a total of 8 chips on M1 Ultra",
                        "As we saw with the launch of the M1 Max, Apple already provides more bandwidth to their SoCs than the CPU cores alone can consume, so the doubled bandwidth isn’t likely to have much of an impact there than otherwise ensuring that the CPU cores are just as well fed as they are on the M1 Max",
                        "With 32 GPU cores, M1 Max was already setting records for a monolithic, integrated GPU",
                        "And now Apple has doubled things to 64 GPU cores on a single chip",
                        "But, if you could somehow link up multiple GPUs with a ridiculous amount die to die bandwidth – enough to replicate their internal bandwidth – then you might just be able to use them together in a single task"
                    ]
                ]
            ],
            [
                ...
                [
                    "p",
                    [
                        "The secret ingredient that makes this all possible – and which Apple has been keeping under wraps until today – is that M1 Max has a very high speed interface along one of its edges",
                        "An interface that, with the help of a silicon interposer, allows two M1 Max dies to be linked up",
                        ...
                        "With UltraFusion, Apple is able to offer an incredible 2.5TB/second of bandwidth between the two M1 Max dies",
                        "We’ll go more into this in the obligatory follow up article, but the important point to take away here is that Apple has become the first vendor to bond two GPUs together with such a massive amount of bandwidth",
                        "For example, is 2.5TB/second enough, given the high performance of the GPUs? And what is the performance impact of the additional latency in going from GPU to GPU? Just because Apple has doubled the number of GPU cores by gluing them together doesn’t mean Apple has doubled their GPU performance"
                    ]
                ]
            ],
            [
                ...
                [
                    ...
                    [
                        ...
                        "In particular, the company is touting that the M1 Ultra’s GPU performance exceeds that of NVIDIA’s GeForce RTX 3090, which at the moment is the single fastest video card on the market",
                        "For as fast as the RTX 3090 is, it can’t be overstated just how many more transistors Apple is throwing at the matter than NVIDIA is; the GA102 GPU used by NVIDIA has 28.3 billion transistors, while the combined M1 Ultra is 114 billion",
                        "Not all of which are being used for graphics on the M1 Ultra, of course, but with so many transistors, Apple doesn’t have to be shy about throwing more silicon at the problem",
                        "As we’ve already seen with the M1 Max, Apple has built a wide enough GPU that they can keep clockspeeds nice and low on the voltage/frequency curve, which keeps overall power consumption down",
                        "Still, given the ground breaking nature of what Apple is trying to pull off with their transparent multi GPU design, it has to be emphasized that Apple’s performance claims should be taken with a grain of salt, at least for now"
                    ]
                ]
            ],
            [
                ...
                [
                    "p",
                    [
                        "While Apple has telegraphed their intention to scale up their chip designs since the first days of their Apple Silicon powered Macs, I believe it’s safe to say that the M1 Ultra exceeds most expectations",
                        "Having reached the practical limits of how big they can make a single die, Apple has taken the logical next step and started placing multiple dies on a single chip in order to build a workstation class processor",
                        "If their transparent multi GPU technology works as well as the company claims, then Apple is going to be even farther ahead of their competitors both in performance and in developing the cutting edge technologies needed to build such a chip",
                        "In that respect, while Apple is trailing the industry a bit with their UltraFusion 2.5D chip packing technology, what they’re attempting to do with it is more than making up for lost time",
                        "Apple has already set a rather high bar with the M1 Max, and now they’re aiming to exceed it with the M1 Ultra"
                    ]
                ]
            ]
        ]
    ...
    [
        [
            ...
            [
                "time",
                [
                    "\n  Mar 12, 2022,  6:00am EST\n"
                ]
            ],
            [
                "p",
                [
                    "Apple’sApple’s transition to its own processors is nearly complete. The company’s recent spring event saw the debut of the Mac Studio and its M1 Ultra processor — its most powerful piece of silicon yet. But it also revealed what the future of Apple’s computers could look like. ",
            ...
            [
                "img",
                [
                    "https://cdn.vox-cdn.com/thumbor/l3p3HkQw-5gKGsLo5xBcQHZ9xTU=/0x0:2000x1125/1200x0/filters:focal(0x0:2000x1125):no_upscale()/cdn.vox-cdn.com/uploads/chorus_asset/file/23298631/lcimg_81d8f753_d066_4188_b9c0_4dc86fe9b86f.jpg",
                    ""
                ]
            ],
            [
            ...
            [
                "img",
                [
                    "https://cdn.vox-cdn.com/thumbor/036OCiwAlHuh9-1Xbjmg4wI-lHw=/0x0:2040x1360/1200x0/filters:focal(0x0:2040x1360):no_upscale()/cdn.vox-cdn.com/uploads/chorus_asset/file/22046476/vpavic_4291_20201113_0366.0.jpg",
                    "",
                    "https://cdn.vox-cdn.com/thumbor/4JNCQFXgNTYEASJfjWrwbVqC7LI=/0x0:2040x1360/1200x0/filters:focal(0x0:2040x1360):no_upscale()/cdn.vox-cdn.com/uploads/chorus_asset/file/22965897/akrales_211028_4820_0523.jpg",
                    ""
                ]
            ],
            [
            ...
            [
                "img",
                [
                    "https://cdn.vox-cdn.com/thumbor/63dZ6oT5mXKdHOwMigRs4gCd7Fk=/0x0:2560x1440/1200x0/filters:focal(0x0:2560x1440):no_upscale()/cdn.vox-cdn.com/uploads/chorus_asset/file/23307251/2022_3_8_apple_186_10_23_29.jpg",
                    "A glowing rainbow M1 Ultra chip, surrounded by baked in memory modules"
                ]
            ],
            [
                "p",
        ...
        [
            ...
            [
                "img",
                [
                    "https://cdn.vox-cdn.com/thumbor/RHUGfBjz_CEQ4CVE6C2pR5X1lNQ=/0x0:2560x1440/1200x0/filters:focal(0x0:2560x1440):no_upscale()/cdn.vox-cdn.com/uploads/chorus_asset/file/23307263/2022_3_8_apple_177_10_17_28.jpg",
                    ""
                ]
            ],
            [
    ...
    "content": [
        [
            ...
            [
                "p",
                [
                    "Ukraine (Ukrainian: Україна, romanized: Ukraïna, pronounced [ʊkrɐˈjinɐ] ) is a country in Eastern Europe. It is the second-largest country by area in Europe after Russia, which it borders to the east and north-east. Ukraine also shares borders with Belarus to the north; Poland, Slovakia, and Hungary to the west; Romania and Moldova to the south; and has a coastline along the Sea of Azov and the Black Sea. It spans an area of 603,628 km2 (233,062 sq mi). With a population of 43 million, Ukraine is the eighth-most populous country in Europe. The nation's capital and largest city is Kyiv.\n",
                    "The territory of modern Ukraine has been inhabited since 32,000 BCE. During the Middle Ages, the area was a key centre of East Slavic culture, with the loose tribal federation Kyivan Rus' forming the basis of Ukrainian identity. Reaching its height in the mid-11th century, the Kyivan Rus' gradually declined until its collapse from the Mongol invasion in the 13th century. Over the next 600 years, the area was contested, divided, and ruled by a variety of powers, including the Polish–Lithuanian Commonwealth, the Austrian Empire and Austria-Hungary in Western Ukraine, the Ottoman Empire in Southern Ukraine, and Tsardom of Russia in Eastern Ukraine. The Cossack Hetmanate emerged and prospered in Central Ukraine during the 17th and 18th centuries but was ultimately partitioned between the Russian Empire (Left-bank Ukraine) and Poland (Right-bank Ukraine), later annexed by the Russian Empire in the Second Partition of Poland. In the aftermath of the Russian Revolution, a Ukrainian national movement for self-determination emerged, forming the internationally recognized Ukrainian People's Republic on 23 June 1917. The short-lived state was forcibly reconstituted by the Bolsheviks into the Ukrainian Soviet Socialist Republic, which became a founding member of the Soviet Union in 1922. From 1932 to 1933 the Holodomor killed millions of Ukrainians. In 1939, following the Molotov–Ribbentrop Pact, Western Ukraine was annexed by the USSR and came under the control of Moscow for the first time in its history. Ukraine was the most populous and industrialised republic after the Russian Soviet Republic, until regaining its independence in 1991, following the dissolution of the Soviet Union.\n",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/3/3b/Pektoral111.JPG/200px-Pektoral111.JPG",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/d/db/Principalities_of_Kievan_Rus%27_%281054-1132%29.jpg/290px-Principalities_of_Kievan_Rus%27_%281054-1132%29.jpg",
                    "The furthest extent of Kyivan Rus', 1054–1132"
                ]
            ],
            [
                "p",
                [
                    "The establishment of the Kyivan Rus' remains obscure and uncertain; there are at least three versions depending on interpretations of the chronicles. In general, the state included much of present-day Ukraine, Belarus and Russia. According to the Primary Chronicle the Rus' elite and rulers initially consisted of Varangians from Scandinavia. In 882, the pagan Prince Oleg (Oleh) conquered Kyiv from Askold and Dir and proclaimed it as the capital of the Rus'. However, it also believed that the East Slavic tribes along the southern parts of the Dnieper River were already in the process of forming a state independently. \n",
                    "During the 10th and 11th centuries, Kyivan Rus' became the largest and most powerful state in Europe. The Varangians later assimilated into the Slavic population and became part of the first Rus' dynasty, the Rurik dynasty. Kyivan Rus' was composed of several principalities ruled by the interrelated Rurikid kniazes (\"princes\"), who often fought each other for possession of Kyiv.\n",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/en/thumb/d/dd/Polish-Lithuanian_Commonwealth_at_its_maximum_extent.svg/220px-Polish-Lithuanian_Commonwealth_at_its_maximum_extent.svg.png",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/3/33/Hondius_Bohdan_Khmelnytsky.jpg/170px-Hondius_Bohdan_Khmelnytsky.jpg",
                    "Hetman Bohdan Khmelnytsky established an independent Ukrainian Cossack state after the 1648 uprising against Poland."
                ]
            ],
            [
                "p",
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/e/e9/Marten%27s_Poltava.jpg/220px-Marten%27s_Poltava.jpg",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/f/f9/1904_Map_showing_Ukraine_region_before_unification.pdf/page1-220px-1904_Map_showing_Ukraine_region_before_unification.pdf.jpg",
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Polish_troops_in_Kiev.jpg/220px-Polish_troops_in_Kiev.jpg",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/f/f7/Huculy_1933%2C_Verkhovyna_district.jpg/170px-Huculy_1933%2C_Verkhovyna_district.jpg",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/a/ad/DneproGES.jpg/220px-DneproGES.jpg",
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/0/0d/HolodomorUcrania9.jpg/220px-HolodomorUcrania9.jpg",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/0/07/Ukraine-growth.png/300px-Ukraine-growth.png",
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/f/fe/%D0%9C%D0%B0%D1%80%D1%88%D0%B0%D0%BB_%D0%A1%D0%BE%D0%B2%D0%B5%D1%82%D1%81%D0%BA%D0%BE%D0%B3%D0%BE_%D0%A1%D0%BE%D1%8E%D0%B7%D0%B0_%D0%93%D0%B5%D1%80%D0%BE%D0%B9_%D0%A1%D0%BE%D0%B2%D0%B5%D1%82%D1%81%D0%BA%D0%BE%D0%B3%D0%BE_%D0%A1%D0%BE%D1%8E%D0%B7%D0%B0_%D0%A1%D0%B5%D0%BC%D1%91%D0%BD_%D0%9A%D0%BE%D0%BD%D1%81%D1%82%D0%B0%D0%BD%D1%82%D0%B8%D0%BD%D0%BE%D0%B2%D0%B8%D1%87_%D0%A2%D0%B8%D0%BC%D0%BE%D1%88%D0%B5%D0%BD%D0%BA%D0%BE.jpg/180px-%D0%9C%D0%B0%D1%80%D1%88%D0%B0%D0%BB_%D0%A1%D0%BE%D0%B2%D0%B5%D1%82%D1%81%D0%BA%D0%BE%D0%B3%D0%BE_%D0%A1%D0%BE%D1%8E%D0%B7%D0%B0_%D0%93%D0%B5%D1%80%D0%BE%D0%B9_%D0%A1%D0%BE%D0%B2%D0%B5%D1%82%D1%81%D0%BA%D0%BE%D0%B3%D0%BE_%D0%A1%D0%BE%D1%8E%D0%B7%D0%B0_%D0%A1%D0%B5%D0%BC%D1%91%D0%BD_%D0%9A%D0%BE%D0%BD%D1%81%D1%82%D0%B0%D0%BD%D1%82%D0%B8%D0%BD%D0%BE%D0%B2%D0%B8%D1%87_%D0%A2%D0%B8%D0%BC%D0%BE%D1%88%D0%B5%D0%BD%D0%BA%D0%BE.jpg",
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/d/d6/Ruined_Kiev_in_WWII.jpg/220px-Ruined_Kiev_in_WWII.jpg",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/en/thumb/c/c8/Khrushchev_and_Brezhnev.jpg/170px-Khrushchev_and_Brezhnev.jpg",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/4/43/RIAN_archive_848095_Signing_the_Agreement_to_eliminate_the_USSR_and_establish_the_Commonwealth_of_Independent_States.jpg/220px-RIAN_archive_848095_Signing_the_Agreement_to_eliminate_the_USSR_and_establish_the_Commonwealth_of_Independent_States.jpg",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/7/7b/Joesjtsjenko_Marion_Kiev_2004.jpg/220px-Joesjtsjenko_Marion_Kiev_2004.jpg",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/4/45/Euromaidan_01.JPG/220px-Euromaidan_01.JPG",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/a/a5/2014_Russo-ukrainian-conflict_map.svg/220px-2014_Russo-ukrainian-conflict_map.svg.png",
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/9/9e/OSCE_SMM_monitoring_the_movement_of_heavy_weaponry_in_eastern_Ukraine_%2816705750566%29.jpg/220px-OSCE_SMM_monitoring_the_movement_of_heavy_weaponry_in_eastern_Ukraine_%2816705750566%29.jpg",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/b/b4/Pontic_Caspian_climate.png/300px-Pontic_Caspian_climate.png",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Koppen-Geiger_Map_UKR_present.svg/260px-Koppen-Geiger_Map_UKR_present.svg.png",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/d/db/Klavdievo_forest.JPG/220px-Klavdievo_forest.JPG",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/3/3d/Chart_Constitution_of_Ukraine_EN.svg/260px-Chart_Constitution_of_Ukraine_EN.svg.png",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/e/e1/Klov_Palace._Listed_ID_80-382-0462._-_8_Pylypa_Orlyka_Street%2C_Pechersk_Raion%2C_Kiev._-_Pechersk_28_09_13_396.jpg/220px-Klov_Palace._Listed_ID_80-382-0462._-_8_Pylypa_Orlyka_Street%2C_Pechersk_Raion%2C_Kiev._-_Pechersk_28_09_13_396.jpg",
                    "Klovsky Palace, home to the Supreme Court of Ukraine",
                    "//upload.wikimedia.org/wikipedia/commons/thumb/1/10/%D0%91%D1%83%D0%B4%D0%B8%D0%BD%D0%BE%D0%BA_%D1%83%D1%80%D1%8F%D0%B4%D1%83_%D0%A3%D0%BA%D1%80%D0%B0%D1%97%D0%BD%D0%B8%2C_%D0%9A%D0%B8%D1%97%D0%B2.JPG/220px-%D0%91%D1%83%D0%B4%D0%B8%D0%BD%D0%BE%D0%BA_%D1%83%D1%80%D1%8F%D0%B4%D1%83_%D0%A3%D0%BA%D1%80%D0%B0%D1%97%D0%BD%D0%B8%2C_%D0%9A%D0%B8%D1%97%D0%B2.JPG",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Batumi_International_Conference%2C_on_19_July_2021_03_%28cropped%29.jpg/220px-Batumi_International_Conference%2C_on_19_July_2021_03_%28cropped%29.jpg",
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/7/7e/EU_DCFTA_EFTA.svg/220px-EU_DCFTA_EFTA.svg.png",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/f/f7/Kissing_the_flag.jpg/220px-Kissing_the_flag.jpg",
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/0/01/Het%27man_Sahaidachnyi_ide_na_chornomu_mori_2012-07-17.jpg/220px-Het%27man_Sahaidachnyi_ide_na_chornomu_mori_2012-07-17.jpg",
            ...
            [
                "p",
                [
                    "Ukraine has been playing an increasingly larger role in peacekeeping operations. In 2014, the Ukrainian frigate Hetman Sagaidachniy joined the European Union's counter piracy Operation Atalanta and will be part of the EU Naval Force off the coast of Somalia for two months. Ukrainian troops were deployed in Kosovo as part of the Ukrainian-Polish Battalion. \n",
                    "A Ukrainian unit was deployed in Lebanon, as part of UN Interim Force enforcing the mandated ceasefire agreement. There was also a maintenance and training battalion deployed in Sierra Leone. In 2003–05, a Ukrainian unit was deployed as part of the Multinational force in Iraq under Polish command.\n",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Map_of_Ukraine_with_Cities.png/350px-Map_of_Ukraine_with_Cities.png",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/a/af/%D0%9C%D1%96%D1%81%D1%82_%D0%9F%D0%B0%D1%82%D0%BE%D0%BD%D0%B0_%D0%B7_%D0%BD%D1%96%D1%87%D0%BD%D0%BE%D1%8E_%D0%B0%D1%80%D1%85%D1%96%D1%82%D0%B5%D0%BA%D1%82%D1%83%D1%80%D0%BD%D0%BE%D1%8E_%D0%BF%D1%96%D0%B4%D1%81%D0%B2%D1%96%D1%82%D0%BA%D0%BE%D1%8E_%D1%82%D0%B0_%D0%BF%D0%B0%D0%BD%D0%BE%D1%80%D0%B0%D0%BC%D0%B0_%D0%9B%D1%96%D0%B2%D0%BE%D0%B3%D0%BE_%D0%B1%D0%B5%D1%80%D0%B5%D0%B3%D0%B0.jpg/220px-%D0%9C%D1%96%D1%81%D1%82_%D0%9F%D0%B0%D1%82%D0%BE%D0%BD%D0%B0_%D0%B7_%D0%BD%D1%96%D1%87%D0%BD%D0%BE%D1%8E_%D0%B0%D1%80%D1%85%D1%96%D1%82%D0%B5%D0%BA%D1%82%D1%83%D1%80%D0%BD%D0%BE%D1%8E_%D0%BF%D1%96%D0%B4%D1%81%D0%B2%D1%96%D1%82%D0%BA%D0%BE%D1%8E_%D1%82%D0%B0_%D0%BF%D0%B0%D0%BD%D0%BE%D1%80%D0%B0%D0%BC%D0%B0_%D0%9B%D1%96%D0%B2%D0%BE%D0%B3%D0%BE_%D0%B1%D0%B5%D1%80%D0%B5%D0%B3%D0%B0.jpg",
            ...
            [
                "p",
                [
                    "Ukraine has a lower-middle income economy, which is the 55th largest in the world by nominal GDP, and the 40th largest by PPP. It is one of the world's largest grain exporters. However, Ukraine remains among the poorest in Europe and most severely corrupt countries in the continent. According to the IMF, Ukraine's GDP per capita by PPP is $14,146.\n",
                    "In 2021, the average nominal salary in Ukraine reached its highest level at ₴14,282 (or $525) per month. In 2018, Ukraine's median wealth per adult was $40, one of the lowest in the world. Approximately 1.1% of Ukrainians lived below the national poverty line in 2019. Unemployment in Ukraine was 4.5% in 2019. In 2019 5–15% of the Ukrainian population were categorized as middle class. As of September 2020[update], Ukraine's government debt is roughly 52% of its nominal GDP.\n",
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/d/d0/%D0%A1%D1%82%D0%B0%D1%80%D0%B0_%D1%84%D0%BE%D1%80%D1%82%D0%B5%D1%86%D1%8F.jpg/220px-%D0%A1%D1%82%D0%B0%D1%80%D0%B0_%D1%84%D0%BE%D1%80%D1%82%D0%B5%D1%86%D1%8F.jpg",
            ...
            [
                ...
                [
                    ...
                    "Well-known Ukrainian brands include Naftogaz Ukrainy, AvtoZAZ, PrivatBank, Roshen, Yuzhmash, Nemiroff, Motor Sich, Khortytsia, Kyivstar and Aerosvit.\n"
                ]
            ]
        ],
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/4/4d/%D0%A1%D0%BA%D0%BE%D1%80%D0%BE%D1%81%D1%82%D0%BD%D0%BE%D0%B9_%D0%BF%D0%BE%D0%B5%D0%B7%D0%B4_%22%D0%A5%D0%B5%D0%BD%D0%B4%D0%B0%D0%B9%22.jpg/220px-%D0%A1%D0%BA%D0%BE%D1%80%D0%BE%D1%81%D1%82%D0%BD%D0%BE%D0%B9_%D0%BF%D0%BE%D0%B5%D0%B7%D0%B4_%22%D0%A5%D0%B5%D0%BD%D0%B4%D0%B0%D0%B9%22.jpg",
            ...
            [
                "p",
                [
                    "Transport in Ukraine includes ground transportation (road and rail), water (sea and river), air transportation, and pipelines. In total, Ukrainian paved roads stretch for 164,732 kilometres (102,360 mi).\n",
                    "International maritime travel is mainly provided through the Port of Odessa, from where ferries sail regularly to Istanbul, Varna and Haifa. The largest ferry company presently operating these routes is Ukrferry. 1,672 km (1,039 mi) navigable waterways on 7 rivers, most of them are on Danube, Dnieper and Pripyat rivers. All Ukraine's rivers freeze over in winter (usually December through March), limiting navigation. However, river icebreakers are available on the Dnieper, at least in vicinity of Kyiv.\n",
                    ...
                    "Ukraine International Airlines, is the flag carrier and the largest airline, with its head office in Kyiv and its main hub at Kyiv's Boryspil International Airport. It operates domestic and international passenger flights and cargo services to Europe, the Middle East, the United States, Canada, and Asia.\n"
                ]
            ]
        ],
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/f/fa/Electricity-prod-source-stacked.svg/260px-Electricity-prod-source-stacked.svg.png",
        ...
        [
            ...
            [
                "p",
                [
                    "The Internet in Ukraine is well developed and steadily growing, mostly uninfluenced by the global financial crisis; in April 2012 rapid growth was forecast for at least two more years. As of 2011[update], Ukraine was ranked 9th in the \"Top 10 Internet countries in Europe\", with then 33.9% Internet penetration and 15.3 million users; growing to 36.8% in 2012. However, as of January 2021[update] about 30 million Ukrainians (85% of the country's population older than 15) were Internet users. Freedom House concluded that the Internet in Ukraine is \"Partly Free\" in 2019 and 2020. A Research & Branding Group February 2021 poll found that for the first time Ukrainians preferred the Internet as their primary news source instead of television (51% preferred the Internet and 41% TV)..\n",
        ...
        [
            ...
            [
                ...
                [
                    ...
                    "In the late 2010s 1.4 million Ukrainians were internally displaced due to the war in Donbas, and in early 2022 over a million fled the country because of the Russo-Ukrainian war.\n"
                ]
            ]
        ],
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/4/4f/UkraineNativeLanguagesCensus2001detailed-en.png/290px-UkraineNativeLanguagesCensus2001detailed-en.png",
            ...
            [
                "p",
                [
                    "Effective in August 2012, a new law on regional languages entitles any local language spoken by at least a 10 percent minority be declared official within that area. Russian was within weeks declared as a regional language in several southern and eastern oblasts (provinces) and cities. Russian can now be used in these cities'/oblasts' administrative office work and documents.\n",
                    "On 23 February 2014, following the Revolution of Dignity, the Ukrainian Parliament voted to repeal the law on regional languages, making Ukrainian the sole state language at all levels; however, the repeal was not signed by acting President Turchynov or by President Poroshenko. In February 2019, the law allowing for official use of regional languages was found unconstitutional.\n",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/f/fd/Kij%C3%B3w_-_Sob%C3%B3r_M%C4%85dro%C5%9Bci_Bo%C5%BCej_01.jpg/220px-Kij%C3%B3w_-_Sob%C3%B3r_M%C4%85dro%C5%9Bci_Bo%C5%BCej_01.jpg",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/a/af/%D0%9C%D1%96%D1%81%D1%8C%D0%BA%D0%B0_%D0%B4%D0%B8%D1%82%D1%8F%D1%87%D0%B0_%D0%BB%D1%96%D0%BA%D0%B0%D1%80%D0%BD%D1%8F_%28%D0%9A%D1%80%D0%B5%D0%BC%D0%B5%D0%BD%D1%87%D1%83%D0%BA%29_-_04.JPG/200px-%D0%9C%D1%96%D1%81%D1%8C%D0%BA%D0%B0_%D0%B4%D0%B8%D1%82%D1%8F%D1%87%D0%B0_%D0%BB%D1%96%D0%BA%D0%B0%D1%80%D0%BD%D1%8F_%28%D0%9A%D1%80%D0%B5%D0%BC%D0%B5%D0%BD%D1%87%D1%83%D0%BA%29_-_04.JPG",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Universidad_Roja_de_Kiev.jpg/200px-Universidad_Roja_de_Kiev.jpg",
                    "The University of Kyiv is one of Ukraine's most important educational institutions.",
                    "//upload.wikimedia.org/wikipedia/commons/thumb/d/de/%D0%A0%D0%B5%D0%B7%D0%B8%D0%B4%D0%B5%D0%BD%D1%86%D1%96%D1%8F_%D0%BC%D0%B8%D1%82%D1%80%D0%BE%D0%BF%D0%BE%D0%BB%D0%B8%D1%82%D1%96%D0%B2_%D0%91%D1%83%D0%BA%D0%BE%D0%B2%D0%B8%D0%BD%D0%B8_%D1%96_%D0%94%D0%B0%D0%BB%D0%BC%D0%B0%D1%86%D1%96%D1%97_5.jpg/200px-%D0%A0%D0%B5%D0%B7%D0%B8%D0%B4%D0%B5%D0%BD%D1%86%D1%96%D1%8F_%D0%BC%D0%B8%D1%82%D1%80%D0%BE%D0%BF%D0%BE%D0%BB%D0%B8%D1%82%D1%96%D0%B2_%D0%91%D1%83%D0%BA%D0%BE%D0%B2%D0%B8%D0%BD%D0%B8_%D1%96_%D0%94%D0%B0%D0%BB%D0%BC%D0%B0%D1%86%D1%96%D1%97_5.jpg",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/6/67/Ukr_elections_2014_multimandate_okruhs.png/290px-Ukr_elections_2014_multimandate_okruhs.png",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/2/2e/Pysanky2011.JPG/220px-Pysanky2011.JPG",
            ...
            [
                ...
                [
                    ...
                    "As of 2022[update], UNESCO inscribed seven properties in Ukraine on the World Heritage List. Ukraine is also known for its decorative and folk traditions such as Petrykivka painting, Kosiv ceramics, and Cossack songs.\n",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/8/80/Rushnyk_-_Ukraine_embroidered_decorative_towels..jpg/220px-Rushnyk_-_Ukraine_embroidered_decorative_towels..jpg",
        ...
        [
            ...
            [
                "p",
                [
                    "The history of Ukrainian literature dates back to the 11th century, following the Christianisation of Kievan Rus'. The writings of the time were mainly liturgical and were written in Old Church Slavonic. Historical accounts of the time were referred to as chronicles, the most significant of which was the Primary Chronicle. Literary activity faced a sudden decline during the Mongol invasion of Rus'.\n"
                ]
            ],
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/4/4f/Taras_Shevchenko_selfportrait_oil_1840-2.jpg/147px-Taras_Shevchenko_selfportrait_oil_1840-2.jpg",
                    "Taras Shevchenko, self-portrait",
                    "//upload.wikimedia.org/wikipedia/commons/thumb/a/a6/%D0%9B%D0%B5%D1%81%D1%8F_%D0%A3%D0%BA%D1%80%D0%B0%D1%97%D0%BD%D0%BA%D0%B0.1888.jpg/137px-%D0%9B%D0%B5%D1%81%D1%8F_%D0%A3%D0%BA%D1%80%D0%B0%D1%97%D0%BD%D0%BA%D0%B0.1888.jpg",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/9/9b/80-391-9007_Kyiv_St.Michael%27s_Golden-Domed_Monastery_RB_18.jpg/220px-80-391-9007_Kyiv_St.Michael%27s_Golden-Domed_Monastery_RB_18.jpg",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Cossack_Mamay_1st_half_of_19th_c_%284%29.jpg/220px-Cossack_Mamay_1st_half_of_19th_c_%284%29.jpg",
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/d/d9/%D0%9B%D0%B8%D1%81%D0%B5%D0%BD%D0%BA%D0%BE_%D0%9C%D0%B8%D0%BA%D0%BE%D0%BB%D0%B0_%28cropped%29.jpg/170px-%D0%9B%D0%B8%D1%81%D0%B5%D0%BD%D0%BA%D0%BE_%D0%9C%D0%B8%D0%BA%D0%BE%D0%BB%D0%B0_%28cropped%29.jpg",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/5/50/Muratova.jpg/170px-Muratova.jpg",
        ...
        [
            ...
            [
                "p",
                [
                    "The Ukrainian legal framework on media freedom is deemed \"among the most progressive in eastern Europe\", although implementation has been uneven. The constitution and laws provide for freedom of speech and press. However, the government does not always respect these rights in practice. The main regulatory authority for the broadcast media is the National Television and Radio Broadcasting Council of Ukraine (NTRBCU), tasked with licensing media outlets and ensure their compliance with the law.\n",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/6/62/Andriy_Shevchenko_goal_celebration_Euro_2012_vs_Sweden.jpg/220px-Andriy_Shevchenko_goal_celebration_Euro_2012_vs_Sweden.jpg",
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/d/d8/VladimirVitaliy.jpg/170px-VladimirVitaliy.jpg",
        ...
        [
            ...
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/5/5f/Wareniki.JPG/220px-Wareniki.JPG",
            ...
            [
                ...
                [
                    ...
                    "Ukrainians drink stewed fruit, juices, milk, buttermilk (they make cottage cheese from this), mineral water, tea and coffee, beer, wine and horilka. The first coffeehouse in Austria was opened by Jerzy Franciszek Kulczycki, while modern Lviv is famous for its chocolate and coffee traditions.\n"
                ]
            ],
            [
                "img",
                [
                    "//upload.wikimedia.org/wikipedia/commons/thumb/4/49/Flag_of_Ukraine.svg/32px-Flag_of_Ukraine.svg.png",
                    "flag",
                    "//upload.wikimedia.org/wikipedia/commons/thumb/c/c6/Europe_%28orthographic_projection%29.svg/28px-Europe_%28orthographic_projection%29.svg.png",
                    "map"
                ]
            ]
        ]
    ...
    "content": [
        ...
        [
            ...
            [
                "p",
                [
                    "Au IXe siècle, Kiev est prise aux Khazars par les Varègues (Vikings orientaux en russe venant de Suède) d’Oleh le Sage (de Novgorod)",
                    "Située sur des routes marchandes lucratives, Kiev devient rapidement le centre d'un puissant État slave, appelé « Rus » ou Ruthénie.\nSelon la tradition, en 988 eut lieu, sous le règne de Vladimir le Beau Soleil, le baptême de ce que seront les peuples russe, ukrainien et biélorusse.\nSous le règne de Iaroslav le Sage (1016 – 1054), le prestige de l'État kiévien atteint son apogée : il s'étend alors de la mer Baltique à la mer Noire et du confluent de l'Oka avec la Volga jusqu'aux Carpates septentrionales",
                    "Kiev est saccagée par la principauté de Vladimir (1169) durant la lutte pour le pouvoir entre les princes, et plus tard par les Coumans et les Tatars Mongols aux XIIe et XIIIe siècles"
                ]
            ]
        ],
        [
            ...
            [
                "p",
                [
                    "Durant le XIVe siècle, les Polonais et les Lituaniens combattirent les Mongols et finalement toute l’Ukraine du nord ouest passa sous l’autorité de la Pologne Lituanie, qui annexe Kiev en 1362",
                    "Les Tatars se maintiennent dans la steppe pontique au nord de la mer Noire et en Crimée ; toutefois, de 1382 à 1484, le grand duché de Lituanie atteignit la mer Noire du côté d’Oçaq (ou Otchakiv, vers l’actuelle Odessa)",
                    "Dans ces régions du nord ouest, outre les Ukrainiens que l’on nommait à l’époque Russyns, Ruthènes, le pays comptait des Polonais, des Moldaves, des Allemands, des Arméniens, des Juifs et des Russes",
                    "Si la Pologne mène une politique relativement tolérante vis à vis de l’orthodoxie, elle favorise cependant le catholicisme qui progresse dans les territoires occidentaux de l'actuelle Ukraine.\n L’influence polonaise pénètre plus lentement dans les territoires relevant du grand duché de Lituanie",
                    "Le métropolite de Kiev et une partie du haut clergé, en réaction contre les interventions réformatrices du patriarche de Constantinople, se rallient à Rome lors du concile de Brešč (Brest Litovsk) en 1596",
                    "L'Union de l'Église de la Rus' de Kiev avec Rome forma l'Église grecque catholique ukrainienne faisant partie des uniates.\n C’est durant cette domination lituano polonaise, à partir du XVe siècle, que se formèrent les Cosaques, des paysans ruthènes orthodoxes qui refusaient la servitude et l’assimilation aux Polonais catholiques",
                    "Le royaume de Pologne les tolère et les utilise contre les Tatars, puis, à partir du XVIe siècle, contre les Turcs ottomans, devenus suzerains des Tatars de Crimée.\n Le clivage entre le nord ouest, orthodoxe mais d'influence polonaise et lituanienne, c'est à dire occidentale, et le sud est soumis aux Tatars et aux Ottomans, puis conquis et colonisé par l'Empire russe, se retrouve jusqu'à aujourd'hui dans la structure politique du pays : le nord ouest vote plutôt pour les pro européens et se méfie de l'influence russe, tandis que le sud est vote plutôt pour les pro russes, se méfie de l'influence occidentale (souvent assimilée au fascisme depuis la Seconde Guerre mondiale) et peut même se soulever contre le pouvoir de Kiev lorsque ce dernier se rapproche de l'Ouest.\n"
                ]
            ]
        ],
        [
        ...
        [
            ...
            [
                "p",
                [
                    "Comme d’autres peuples en Europe, un mouvement de renaissance nationale ukrainien se fait jour à partir du milieu du XIXe siècle dans l’Empire russe",
        ...
        [
            ...
            [
                "p",
                [
                    "Après la révolution de Février, qui met fin à l’Empire en 1917, l'Ukraine est brièvement indépendante jusqu'en 1920, mais la Rada ne parvient pas à contrôler efficacement le territoire, envahi d'abord par les Allemands puis, à leur retrait, devenu champ de bataille entre le Parti bolchevique, les Russes blancs et les forces de la Triple Entente.\n Le , la plupart des partis politiques s’accordent pour former la Rada ukrainienne centrale",
                    "En tant que chef de l'USDRP, Volodymyr Vynnytchenko est choisi comme un des deux vice présidents de la Rada centrale puis comme le premier président du secrétariat général de la Rada centrale du gouvernement autonome de l'Ukraine.\n Le  ( dans le calendrier grégorien), soit treize jours après que le Parti bolchevique russe a renversé le gouvernement social démocrate de Saint Pétersbourg — alors capitale de la Russie —, la Rada ukrainienne centrale proclame la République populaire d’Ukraine et sa séparation de la Russie",
                    "L'indépendance totale de l'Ukraine est confirmée le  et Mykhaïlo Hrouchevsky est élu officiellement « président de la République populaire ukrainienne » le .\n Le traité de Brest Litovsk est signé le  entre les Bolcheviks russes, les gouvernements des empires centraux menés par l'Empire allemand et la jeune République populaire d’Ukraine, issue de la révolution de Février, dans la ville du même nom, aujourd’hui Brest en Biélorussie",
                    "Les 17 , la république socialiste soviétique d'Ukraine est fondée à l'Est du pays avec pour capitale Kharkov.\n Pour combattre l'Armée rouge qui contrôle alors une partie de l’Ukraine, la Rada centrale cherche le soutien des Allemands qui organisent un coup d’État et renversent le gouvernement de Vynnytchenko, mettant à sa place Pavlo Skoropadsky qui, le  — soit, le jour même de l'élection de Mykhaïlo Hrouchevsky à la présidence de la république —, est proclamé hetman de l’« État ukrainien » : Ukrayinska Derjava"
                ]
            ]
        ],
        [
            ...
            [
                "p",
                [
                    "À la fin de 1918, les Alliés interviennent dans le sud de l'Ukraine pour soutenir les Blancs de Dénikine dans la guerre civile russe",
                    "Dans le conflit qui oppose les communistes du centre (Moscou) et les partis communistes nationaux, c'est le centre qui l'emporte et impose une fédération.\n Quand Staline déclenche sa révolution industrielle vers la fin des , l'Ukraine devient l'une des sources indispensables de son financement",
                    "Les années d'industrialisation sont marquées par la construction de ce qui est à l'époque la plus grande centrale hydraulique d'Europe sur le Dniepr (le DnieproGuES), ce qui contribue à l'électrification de la République, ainsi qu'une importante mise en valeur du grand bassin minier et métallurgique, le Donbass, déjà exploité depuis la fin du XIXe siècle.\n Après une brève période d'ukrainisation — politique dite d'indigénisation (korenizatsia) — dans les , se traduisant par le retour à l'ukrainien dans les publications, la réouverture des écoles et des universités avec un enseignement en ukrainien et la promotion des cadres nationaux, Staline ne ménage pas les efforts pour réprimer le moindre signe d'un réveil nationaliste ukrainien, interprété comme un rejet du pouvoir bolchevik et une menace à l'intégrité de l'URSS"
                ]
            ],
            [
                "img",
        ...
        [
            ...
            [
                "p",
                [
                    "En 2010 le pro russe Viktor Ianoukovytch est élu président, mais le courant pro européen et occidental persiste",
                    "Très rapidement, une crise éclate entre les territoires majoritairement russophones du sud est du pays et le nouveau pouvoir central de Kiev.\n Le , la Crimée proclame son indépendance, puis à la suite d'un référendum est rattachée à la fédération de Russie le 18 mars",
                    "Le , l'Assemblée générale de l'ONU a voté la résolution 68/262 sur « l'intégrité territoriale de l'Ukraine », la majorité des pays condamnant le rattachement de la Crimée à la Russie :  dont les États Unis et l'UE.\n Une guerre civile, dite guerre du Donbass, éclate ensuite dans l'est de l'Ukraine majoritairement russophone, qui entraîne plus de dix mille morts.\n L'Ukraine est la cible de cyberattaques dont le but est de réduire la légitimité du pouvoir ukrainien et tester de nouvelles cyberarmes, perturbant également l'économie",
                    "Lors de l'annonce des résultats de l'élection présidentielle en 2014, la principale chaine de télévision, victime d'un piratage, a annoncé des résultats erronés.\n En 2016, l'OSCE, une organisation chargée notamment d’observer le cessez le feu en Ukraine a été la cible d’une attaque de grande ampleur attribuée à Moscou",
                    "L’OSCE est le seul acteur indépendant capable de documenter des exactions ou de vérifier si les promesses faites par Kiev, les prorusses ou le Kremlin sont mises en application.\n Alors que le conflit dans la région du Donbass semble se transformer en conflit de « basse intensité », depuis le début des combats près d'un million et demi de personnes ont été déplacées, 850 000 à l'intérieur de l'Ukraine, 600 000 en dehors dont 350 000 vers la Russie et 250 000 vers les pays de l'Union européenne.\n Le , Joe Biden, président des États Unis, ordonne aux familles de diplomates américains de quitter le territoire ukrainien en raison des fortes tensions avec la Russie, évoquant « la menace persistante d'une opération militaire russe ».\n Le , le président russe Vladimir Poutine reconnait l'indépendance des républiques populaires autoproclamées de Donetsk et de Lougansk et ordonne à ses troupes de se rendre dans ces parties de l'est de l'Ukraine dans le cadre de ce que le Kremlin qualifie de « mission de maintien de la paix ».\n Le , la Russie procède à des bombardements par missiles de croisière et balistiques sur plusieurs villes ukrainiennes, dont Kiev"
                ]
            ]
        ],
        [
        ...
        [
            ...
            [
                "p",
                [
                    "L'Ukraine est un pays d'Europe orientale",
                    "Le pays mesure 1 316 km d'est en ouest et 893 km du nord au sud, pour une superficie totale de 603 550 km2, ou 576 450 km2 sans compter la superficie de la Crimée.\n À l’exception du vaste plateau de Podolie (altitude 472 m) qui occupe l'ouest du pays, c'est un pays relativement plat, avec les terres fertiles du bassin du Dniepr en son centre, ce qui lui permet d'avoir une agriculture productive",
                    "Les montagnes ukrainiennes sont principalement constituées des contreforts des reliefs d'Europe centrale et méditerranéenne :\n L’Ukraine bénéficie également d'un réseau fluvial étendu, composé principalement par le Dniepr (Dnipro), le Dniester (Dnister), le Boug occidental, le Boug méridional et le Donets à l'est",
                    "Le Danube (Dounay) marque la frontière à l'extrême sud ouest entre l'Ukraine et la Roumanie.\n Au sud, l'Ukraine s'ouvre sur la mer Noire, bordée de nombreux « limans », et où s'avance la presqu'île de Crimée.\n Le climat de la majeure partie de l'Ukraine est continental avec des hivers froids et des étés chauds ; le climat n'est méditerranéen que sur la côte sud de la Crimée"
                ]
            ]
        ],
        [
        ...
        [
            ...
            [
                "p",
                [
                    "L'Ukraine est divisée en  régions administratives — ou oblasti (singulier : oblast) — et une municipalité (misto) avec un statut juridique particulier, Kiev",
                    "Par ailleurs, l'Ukraine revendique l'intégralité de la Crimée, autrement dit la ville à statut particulier de Sébastopol et la République autonome de Crimée, qui ont été annexées en 2014 à la Russie et constituent actuellement le District fédéral de Crimée de la Fédération de Russie.\n"
                ]
            ]
        ],
        [
        ...
        [
            ...
            [
                "p",
                [
                    "L'ukrainien est la langue officielle mais treize autres langues minoritaires sont reconnues, dont le russe, qui est très souvent compris par les Ukrainiens",
                    "Les 17 % de russophones sont surtout présents dans l'Est et le Sud du pays, qui ont fait partie pendant plus de 340 ans de l'Empire russe et plus de 70 ans de l'URSS, alors que l'ukrainien est largement dominant dans l'Ouest de l'Ukraine, qui a fait partie de la Pologne et de l'Autriche Hongrie.\n Chez les plus jeunes, surtout dans les grandes villes, le choix de l'anglais en seconde langue devient de plus en plus important",
                    "Dans l'Ouest du pays, on trouve des minorités qui parlent le polonais, le hongrois, le biélorusse, le roumain, le grec, le yiddish, ainsi que le tchèque et le slovaque"
                ]
            ]
        ],
        [
        ...
        [
            ...
            [
                "p",
                [
                    "Alors que la présidence était assurée par Leonid Koutchma, un ancien apparatchik du Parti communiste, considéré comme corrompu et lié aux groupes mafieux, la dernière élection présidentielle a eu lieu le 31 octobre et ",
                    "Sur fond d'accusations réciproques de corruption, le  le président Viktor Iouchtchenko limogea le gouvernement de la Première ministre Ioulia Tymochenko, nommant à sa place Iouriï Iekhanourov, gouverneur de l'oblast de Dnipropetrovsk.\n Des commentateurs comme Jean Baptiste Naudet, reporter au Nouvel Observateur ont estimé que l'on peut observer, à travers plusieurs élections, une préférence pour les candidats pro européens en Ukraine du Nord Ouest jadis soumise à l'influence polono lituanienne, et pour les candidats pro russes en Ukraine du Sud Est jadis soumise à la domination turco tatare et délivrée de celle ci par les cosaques et la Russie.\n"
                ]
            ]
        ],
        [
        ...
        [
            ...
            [
                "p",
                [
                    "Le , le président Viktor Iouchtchenko dissout le parlement et provoque de nouvelles élections législatives",
                    "Elles eurent lieu le , les résultats étaient les suivants :\n Lors des élections législatives anticipées du , le bloc dirigé par Ioulia Tymochenko arrive en deuxième position avec 30,7 % des voix, gagnant presque huit points par rapport aux précédentes législatives de mars 2006 (22,9 %)",
                    "Après les premiers dépouillements, le « Bloc Ioulia Tymochenko » arrivait en tête et l'OSCE avait déclaré que les élections s'étaient déroulées de manière libre et équitable\n Nommée première ministre par le président Iouchtchenko, elle ne parvient pas, cependant, à obtenir la majorité le 11 décembre, obtenant seulement  sur les .\n De nouveau proposée au poste de Premier Ministre, la Rada entérine sa nomination à la tête du gouvernement le 18 décembre lors d'un deuxième vote par  sur les 450.\n La Rada est dissoute par le président Iouchtchenko le  à la suite de la crise parlementaire de septembre 2008 en Ukraine, une élection anticipée d'abord prévue pour le  puis le , a été reportée pour début 2009, à une date indéterminée, en raison de la crise financière"
                ]
            ]
        ],
        [
            ...
            [
                "p",
                [
                    "Le premier tour de l'élection présidentielle s'est déroulé le ",
                    "Le président sortant Viktor Iouchtchenko réunit environ 5,5 % des voix.\n Viktor Ianoukovytch emporte le second tour du 7 février avec 48,95 % des voix contre 45,47 % pour Ioulia Tymochenko",
                    "L'OSCE a annoncé que le scrutin avait été « transparent et honnête ».\n Mykola Azarov, fidèle du président Ianoukovytch, accède au poste de Premier ministre le , à la suite d'une motion de censure votée le 3 mars contre Ioulia Tymochenko.\n"
                ]
            ]
        ],
        [
            ...
            [
                "p",
                [
                    "En novembre 2013, l'Ukraine renonce à signer un accord d'association avec l'Union européenne et « relance un dialogue actif avec Moscou »",
                    "Ce revirement entraîne d'importantes manifestations pro européennes à Kiev rassemblant des centaines de milliers de personnes, l'occupation du Maïdan Nézalejnosti et de la mairie, avec comme mot d'ordre la démission du président Viktor Ianoukovytch.\n"
                ]
            ],
            [
                "img",
        ...
        [
            ...
            [
                "p",
                [
                    "Le , le nouveau président Petro Porochenko signe un accord de libre échange avec l'Union européenne à Bruxelles.\n"
                ]
            ]
        ],
        [
            ...
            [
                ...
                [
                    ...
                    "Les intéressés ont six mois pour cesser leurs activités politiques et vendre leurs médias, sans quoi ils sont fichés comme oligarques et soumis à de fortes contraintes (obligation de déclarer leurs possessions, interdiction de financer des partis politiques, de rencontrer en privé des hauts fonctionnaires ou de participer à des privatisations)"
                ]
            ],
            [
                "img",
            ...
            [
                "p",
                [
                    "Sur le plan international, Zelensky entend relancer le dialogue avec la Russie sur la question du Donbass",
                    "Le début de son mandat est marqué à cet égard par des succès, dont des échanges de prisonniers sans précédent entre l'Ukraine et le camp prorusse et la restitution par Moscou des trois navires ukrainiens arraisonnés lors de l'incident du détroit de Kertch un an plus tôt",
                    "Le , Kiev et Moscou n'en signent pas moins le plus long accord de cessez le feu depuis le début du conflit : celui ci est presque aussitôt fragilisé par des tirs en provenance des territoires séparatistes, le , mais Zelensky réaffirme son attachement à l'accord en imputant ces agissements à des « groupes armés illégaux »",
                    "Après quelques semaines de tensions, Sergueï Choïgou annonce le début du retrait des troupes russes le , mais celles ci se réinstallent massivement à la frontière en fin d'année"
                ]
            ]
        ],
        [
            ...
            [
                "p",
                [
                    "L'Ukraine a une économie diversifiée, mais encore tributaire des industries établies à l'époque soviétique",
                    "Autre point fort de son agriculture, le pays était aussi septième au palmarès des producteurs mondiaux de céréales au milieu des années 2010, dominé par les États Unis, grâce à une forte progression",
        ...
        [
            ...
            [
                "p",
                [
                    "Les principales villes d'Ukraine disposent d'un réseau de transports en commun lourd hérité en partie de l'époque soviétique",
                    "Le métro de la capitale Kiev, est le plus important avec une longueur de 67 kilomètres (1,32 millions de passagers quotidiens)"
                ]
            ]
        ],
        [
        ...
        [
            ...
            [
                "p",
                [
                    "Le pays dispose d'un réseau étendu oléoducs et de gazoducs qui acheminent principalement les produits pétroliers et le gaz naturel russes vers le territoire national et l'Europe occidentale"
                ]
            ]
        ],
        [
            ...
            [
                "p",
                [
                    "L’Ukraine occupait en 2012 la neuvième place en Europe par le nombre de visiteurs",
                    "Les Sept merveilles d'Ukraine ainsi que les « sept merveilles naturelles d’Ukraine » sont des endroits principalement fréquentés par les touristes étrangers",
                    "Depuis 2005, les citoyens de l'Union européenne, de l'AELE, des États Unis, du Canada, du Japon et de la Corée du Sud n'ont plus besoin de visa pour visiter l'Ukraine",
                    "En 2012, la part du tourisme dans le PIB s'est montée à 28,8 milliards de UAH, soit 2,2 % du PIB, tout en procurant directement 351 500 emplois (1,7 % des emplois totaux)"
                ]
            ],
            [
                "img",
            ...
            [
                "p",
                [
                    "L'Ukraine possède de très nombreux sites touristiques dans tout le pays, un littoral sur la mer Noire avec des plages nombreuses et très populaires, des châteaux historiques, des parcs, des sites viticoles et un nombre important de musées répartis dans l'ensemble du pays, et notamment dans les grandes villes de Kiev, Odessa, Donetsk et Lviv"
                ]
            ]
        ],
        [
        ...
        [
            ...
            [
                "p",
                [
                    "Le cinéma ukrainien est à la fois partie prenante du cinéma soviétique et un cinéma original, attaché à la terre et à l'histoire ukrainienne",
                    "Certains auteurs accordent ainsi au cinéma ukrainien un développement parallèle et indépendant du cinéma soviétique, d'autres fixent son essor véritable au lendemain de l'indépendance du pays, en 1991.\n L'histoire du cinéma ukrainien débute de manière précoce, en 1896"
                ]
            ]
        ],
        [
            ...
            [
                "p",
                [
                    "La musique ukrainienne est essentiellement vocale et polyphonique depuis l'avènement de ce style dans la musique liturgique orthodoxe au XVIe siècle",
                    "Pendant longtemps les musiciens à la Cour du tsar et dans les chœurs orthodoxes étaient Ukrainiens"
                ]
            ]
        ],
        [
        ...
        [
            ...
            [
                "p",
                [
                    "Les principales confessions du pays sont chrétiennes, essentiellement orthodoxes et dans une moindre mesure catholiques.\n Le catholicisme représente 9 % de la population, soit environ quatre millions de fidèles",
                    "Il est surtout pratiqué selon le rite byzantin.\n D'autres confessions chrétiennes issues du protestantisme ou encore l'Église apostolique arménienne sont aussi représentées mais en très petit nombre, environ 1 %",
                    "L'islam, qui est principalement la religion des Tatars de Crimée, réunit moins d'1 % des croyants et le judaïsme moins de 0,5 %.\n L'Ukraine dispose d'un patrimoine religieux considérable, parfois très ancien (jusqu'au XVe siècle) et présentant, dans les Carpates, une architecture en bois"
                ]
            ]
        ],
        [
